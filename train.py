...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='/VOCdevkit/pedestrian.yaml', help='data.yaml path')
    ...
    parser.add_argument('--logdir', type=str, default='VOCdevkit/logs', help='logging directory')
